...
export function ProductList({products}) {
  const firstThreeProducts = products.edges.slice(0, 3); // Get the first three products
    ...
    <div>
      <div className="mx-auto max-w-2xl px-4 py-2 sm:px-6 sm:py-12 lg:max-w-7xl lg:px-8">
        <div className="flex items-center justify-between space-x-4">
          ...
          <Link
            to="collections/home" //collection path hardcoded
            className="whitespace-nowrap text-sm font-medium text-slate-500 hover:text-slate-400 dark:text-slate-400 dark:hover:dark:text-slate-200"
          >
            View all
